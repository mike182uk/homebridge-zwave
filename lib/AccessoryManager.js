  ...
  _configureDimLightService () {
    ...
    brightnessCharacteristic
      .on('get', done => {
        ...
        this._log(`${accessoryDisplayName} "Brightness" GET: ${finalvalue}`)
   ...
   _configureColorLightService () {
    ...
    hueCharacteristic
      .on('get', done => {
        ...
        //this._log(`Red: ${rValue.value} Green: ${gValue.value} Blue: ${bValue.value} White: ${wValue.value} `)
        let hsl = convertToHSL(rValue.value, gValue.value, bValue.value);
        //this._log(`h: ${hsl.h} s: ${hsl.s} l: ${hsl.l}`)
      ...
      .on('set', (value, done) => {
        ...
        //this._log(`ColorValue: ${colorValue}`)
