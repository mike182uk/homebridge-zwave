...
class AccessoryConfigurer {
  ...
  _configureMotionSensorService (accessory, zwaveNode) {
    ...
    // Setup the handler for when the value for the "On" characteristic is requested by HomeKit
    ...
    const zwaveNodeValueId = `${zwaveNode.id}-${COMMAND_CLASS_ALARM}-1-${ALARM_INDEX_HOME_SECURITY}` // TODO: is this always going to be the ID?
